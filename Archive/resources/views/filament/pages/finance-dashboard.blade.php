<x-filament-panels::page>
    ...
    <div class="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-900">
        ...
        <div class="flex flex-wrap items-center justify-center gap-3 text-center text-sm">
            <div class="rounded-lg bg-blue-50 px-4 py-3 dark:bg-blue-900/20">
                <div class="text-xs text-gray-500 dark:text-gray-400">رأس المال بالأقساط</div>
            ...
            <div class="rounded-lg bg-red-50 px-4 py-3 dark:bg-red-900/20">
                <div class="text-xs text-gray-500 dark:text-gray-400">مستحقات المستثمرين</div>
            ...
            <div class="rounded-lg border-2 {{ $stats['effective_capital'] >= 0 ? 'border-green-500 bg-green-50 dark:bg-green-900/20' : 'border-red-500 bg-red-50 dark:bg-red-900/20' }} px-6 py-3">
                <div class="text-xs text-gray-500 dark:text-gray-400">الرأسمال الفعلي</div>
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <x-filament::section>
            <div class="flex items-center gap-3">
                ...
                <div>
                    <div class="text-sm text-gray-500 dark:text-gray-400">رأس المال الكلي</div>
        ...
        <x-filament::section>
            <div class="flex items-center gap-3">
                ...
                <div>
                    <div class="text-sm text-gray-500 dark:text-gray-400">رأس المال بالأقساط</div>
        ...
        <x-filament::section>
            <div class="flex items-center gap-3">
                ...
                <div>
                    <div class="text-sm text-gray-500 dark:text-gray-400">مستحقات المستثمرين</div>
    ...
    <div class="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-900">
        ...
        <p class="text-xs text-gray-500 dark:text-gray-400 mb-4">رأس المال الكاش = المبلغ المدخل + تسديدات الزبائن − المصاريف − دفعات المستثمرين</p>
        <div class="flex flex-wrap items-center justify-center gap-3 text-center text-sm">
    ...
    <div class="rounded-xl border-2 {{ $cashRegister >= 0 ? 'border-emerald-300 dark:border-emerald-700' : 'border-red-300 dark:border-red-700' }} bg-white p-6 dark:bg-gray-900">
        ...
        <p class="text-xs text-gray-500 dark:text-gray-400 mb-4">الفرق بين الأرباح المحققة من المبيعات ومستحقات المستثمرين المتراكمة - الفائض يُحفظ والعجز يُسحب تلقائياً</p>
        ...
        <div class="flex flex-wrap items-center justify-center gap-3 text-center text-sm mb-5">
            ...
            <div class="rounded-lg bg-orange-50 px-5 py-3 dark:bg-orange-900/20">
                <div class="text-xs text-gray-500 dark:text-gray-400">مستحقات المستثمرين المتراكمة</div>
        ...
        <div class="rounded-lg border border-red-200 bg-red-50 p-3 dark:border-red-800 dark:bg-red-900/20">
            <div class="flex items-center gap-2">
                ...
                <span class="text-sm font-medium text-red-700 dark:text-red-400">
                    القاصة بالسالب! يوجد عجز بمقدار {{ $iqd(abs($cashRegister)) }} - المبيعات لا تغطي مستحقات المستثمرين
                </span>
            </div>
        </div>
        @else
